...
hi ErrorMsg         term=standout cterm=bold ctermfg=0 ctermbg=1 guifg=#7c7c7c guibg=#f90000
...
hi StatusLineTerm   term=bold cterm=bold ctermfg=0 ctermbg=10 guifg=#000000 guibg=#00d200
hi StatusLineTermNC term=bold cterm=bold ctermfg=0 ctermbg=10 guifg=#000000 guibg=#00d200
hi VertSplit        term=reverse cterm=reverse gui=reverse
hi Title            term=bold ctermfg=5 gui=bold guifg=#db00db
hi Visual           term=reverse cterm=reverse ctermfg=8 ctermbg=7 guifg=#404040 guibg=#7c7c7c
...
hi Folded           term=standout ctermfg=4 ctermbg=8 guifg=#6868ff guibg=#404040
hi FoldColumn       term=standout ctermfg=4 ctermbg=8 guifg=#6868ff guibg=#404040
hi DiffAdd          term=bold ctermfg=0 ctermbg=4 guifg=#404040 guibg=#6868ff
hi DiffChange       term=bold ctermfg=0 ctermbg=5 guifg=#404040 guibg=#db00db
hi DiffDelete       term=bold cterm=bold ctermfg=0 ctermbg=6 gui=bold guifg=#000000 guibg=#008a8a
hi DiffText         term=reverse cterm=bold ctermfg=0 ctermbg=1 gui=bold guifg=#000000 guibg=#f90000
hi SignColumn       term=standout ctermfg=4 ctermbg=8 guifg=#6868ff guibg=#404040
hi Conceal          ctermfg=7 ctermbg=0 guifg=#7c7c7c guibg=#7c7c7c
hi SpellBad         term=reverse ctermfg=0 ctermbg=1 gui=undercurl guisp=#f90000 guifg=#7c7c7c guibg=#f90000
hi SpellCap         term=reverse ctermfg=0 ctermbg=4 gui=undercurl guisp=#6868ff guifg=#404040 guibg=#6868ff
hi SpellRare        term=reverse ctermfg=0 ctermbg=5 gui=undercurl guisp=#db00db guifg=#404040 guibg=#db00db
hi SpellLocal       term=underline ctermfg=0 ctermbg=6 gui=undercurl guisp=#008a8a guifg=#000000 guibg=#008a8a
...
hi ColorColumn      term=reverse ctermfg=0 ctermbg=1 guifg=#000000 guibg=#f90000
...
hi Error            term=reverse cterm=bold ctermfg=0 ctermbg=1 guifg=#000000 guibg=#f90000
